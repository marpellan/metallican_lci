...
def aggregate_carbon_stock_facility_groups(df, remove_individuals=False):
    """
    Aggregate carbon_stock flows by facility_group_id when multiple facilities exist.
    Creates new rows (no main_id, no facility_name) with summed values and
    aggregated lists of commodities and mining_processing_type.
